...
public class InputHandler2 implements GestureListener {
  ...
  public InputHandler2(OrthographicCamera cam, Stage stage) {
    this.cam = cam;
    this.stage = stage;
    jetName = "a";
  ...
  public boolean zoom(float initialDistance, float distance) {
    ...
    cam.zoom = MathUtils.clamp(initialScale * ratio, 0.1f, 100.0f);
